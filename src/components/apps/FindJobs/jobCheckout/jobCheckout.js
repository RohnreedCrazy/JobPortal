...
import AddToCart from '../jobCart/AddToCart';
...
const JobChecout = () => {
  const checkout = useSelector((state) => state.FindJobsReducer.cart);
  ...
  const total = sum(checkout.map((job) => job.salary * job.qty));
